...
* In total, 4,540 polling centers and 25,079 polling stations were included in the IEC’s preliminary results report, or **84.8% of planned**. 2,035 polling stations (6.9% of planned) were confirmed by the IEC to have been invalidated, and 1,799 polling stations (6.1% of planned) were confirmed to have been closed on election day. Another 1,354 polling stations (4.6% of planned) did not appear in the preliminary results or in the IEC's official list of closed or invalidated polling stations.
...
* Analysis of available data on the audit and recount process ordered by the IEC prior to the announcement of the preliminary results noted that:
  ...
  + According to the IEC, **74,720 non-biometrically verified votes** were reported at polling stations that were invalidated prior to the announcement of preliminary results.
...
On December 28 2019, the IEC released a list of invalidated polling stations based on decisions made by the IEC and ECC against the original audit list, and updated this again the following day to also specify some closed polling stations. 1,799 stations (6.1% of planned) were confirmed closed. 2,305 polling stations (6.9% of planned) were listed as having been invalidated, of which 681 stations were previously included in the preliminary results, although in all cases those stations had reported zero vote counts. (Another 457 stations not on the invalidated list were also included in the preliminary results reporting zero votes.) Some discrepancies remain: 1,354 previously planned polling stations (4.6% of planned), including 270 stations selected for audit, did not report any preliminary results but were also not inclued in the invalidated or closed polling station list.
...
The IEC invalidation and closure report of December 28 identifies 2,035 invalidated polling stations out of the 8,268 previously targeted for audit. 681 'invalidated' stations were also included in the preliminary results data but reported zero votes. The total group of invalidated stations was previously reported in the IEC's audit target list to collectively total 4,598 known biometric votes. The post-audit invalidation list also reported non-biometrically verified physical result sheet vote totals, which according to the IEC totaled **74,720 non-biometrically verified votes**.
