...
* In total, 4,540 polling centers and 25,079 polling stations were included in the IEC’s preliminary results report, or **84.8% of planned**. (At least 1138 stations reported zero votes, and some open but invalidated stations may be missing from the preliminary results.)
...
* Complaints adjudication and further decisions on vote validation or invalidation, which will be made in the coming weeks by the Electoral Complaints Commission prior to the certification of final results, will be extremely sensitive. The Abdullah campaign has rejected many of the IEC's decisions and have filed challenges to the reported results. At current margins, **the invalidation of any further votes for Ghani in excess of 25,000 votes would force a runoff**.
...
The **IEC has not released an official report on which planned centers and stations were open or closed on election day**, either due to deliberately planned or unplanned closures. Ommissions from the reported preliminary results may be due to election-day closure, but may also be due a station's invalidation during the audit and recount process, or due to ommission of zero votes being reported despite a station being open. 1138 stations included in the results reported zero votes for any candidates, although this may not be exhaustive of all such cases. 1627 polling stations previously identified for audit were ommitted from the reporting and are presumed to have been invalidated; of those, 1406 stations had been flagged for missing biometric data in the audit process (discussed further in Section IV).
...
provincial_summary_report %>%
  ...
  dplyr::select(province_code, province_name_eng,
                ps_planned, pct_total_planned, ps_reporting, pct_total_reporting, pct_reporting, ps_reporting_zero_votes, pct_open) %>%
  kable(col.names = c("Province Code", "Province Name", 
                      ...
                      "Polling Stations Reporting Zero Votes", "% of Reporting Stations"
                      ),
...
In total, 730 stations in the first category were included in the preliminary results, of which 207 reported non-zero vote totals. In the second category, 287 stations were included in the preliminary results, of which 47 reported non-zero vote totals. **In sum, stations under Decision 105 previously found to be missing biometric records added 27,641 new votes following the audit process**.
