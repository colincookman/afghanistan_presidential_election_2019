...
partial_turnout_reports_10_14_19 <- read_csv("raw/partial_turnout_reports_10_14_19.csv")
partial_turnout_reports_10_14_19 <- filter(partial_turnout_reports_10_14_19, !is.na(province_code))
partial_turnout_reports_10_14_19$X27 <- NULL
partial_turnout_reports_10_14_19$`PS Planned (4938 MOI List of Sept 28)` <- NULL
partial_turnout_reports_10_14_19$X47 <- NULL

colnames(partial_turnout_reports_10_14_19) <- c(
  "province_code", "region_name_eng", "province_name_eng",
  "pc_plan_IEC", "ps_plan_IEC", 
  "pc_plan_MOI", "pc_plan_MOI_pct_IEC",
  "pc_count_09_28", "pc_count_09_29", "pc_count_10_01", "pc_count_10_03",
  ...
  "pc_reporting_pct_MOI_10_01", "pc_reporting_pct_MOI_10_03", "pc_remaining_pct_MOI_10_01",
  "ps_reporting_09_29", "ps_reporting_pct_IEC_09_29", "ps_reporting_10_03", "ps_reporting_pct_IEC_10_03",
  "bvv_reporting_ps_10_14", "bvv_reporting_pct_10_14", "bvv_remaining_ps_projection",
  "partial_votes_09_28", "partial_votes_09_29", "partial_votes_10_01", "partial_votes_10_03",
  "partial_bvv_votes_10_14", "projected_bvv_votes_10_14",
  "net_change_pc_28_29", "net_change_votes_28_29", 
  "net_change_pc_29_01", "net_change_votes_29_01",
  "net_change_votes_proj_bvv_03_14", "pct_change_votes_proj_bvv_03_14",
  "net_change_pc_01_03", "net_change_votes_01_03",
  "avg_votes_pc_09_28", "avg_votes_pc_09_29", "avg_votes_pc_10_01", "avg_votes_pc_10_03",
  "straight_line_projection",
  "vr_total_2019", "turnout_10_03_19",
  "bvv_proj_turnout_10_14_19",
  "total_prelim_votes_2018", "pct_change_votes_2018_10_03_19",
  "vr_total_2018", "pct_change_vr_18_19",
  "turnout_2018", "pct_change_turnout_2018_10_03_19",
  "total_prelim_round_one_votes_2014", "pct_change_votes_2014_10_03_19"
...
partial_turnout_reports_10_14_19$province_code <- as.character(str_pad(partial_turnout_reports_10_14_19$province_code, 2, pad = "0", side = "left"))
partial_turnout_reports_10_14_19 <- left_join(partial_turnout_reports_10_14_19, pc_report_18)

partial_turnout_reports_10_14_19 <- partial_turnout_reports_10_14_19 %>% mutate(
  pc_plan_IEC_pct_plan_18 = pc_plan_IEC / pc_plan_2018,
  pc_plan_MOI_pct_plan_18 = pc_plan_MOI / pc_plan_2018,
  pc_plan_IEC_pct_prelim_reporting_18 = pc_plan_IEC / pc_prelim_reporting_2018,
  pc_plan_MOI_pct_prelim_reporting_18 = pc_plan_MOI / pc_prelim_reporting_2018
...
partial_turnout_reports_10_14_19 <- partial_turnout_reports_10_14_19 %>% dplyr::select(
  region_name_eng, province_code, province_name_eng,
  pc_plan_IEC, ps_plan_IEC, pc_plan_MOI, pc_plan_MOI_pct_IEC, 
  pc_plan_2018, pc_prelim_reporting_2018, pc_plan_IEC_pct_plan_18, pc_plan_MOI_pct_plan_18, 
  pc_plan_IEC_pct_prelim_reporting_18, pc_plan_MOI_pct_prelim_reporting_18,
...
partial_turnout_reports_10_14_19 <- partial_turnout_reports_10_14_19 %>% mutate(
  pct_natl_vote_10_03_19 = partial_votes_10_03 / (sum(partial_turnout_reports_10_14_19$partial_votes_10_03, na.rm = T)),
  pct_natl_vr_19 = vr_total_2019 / (sum(partial_turnout_reports_10_14_19$vr_total_2019, na.rm = T)),
  pct_natl_vote_2018 = total_prelim_votes_2018 / (sum(partial_turnout_reports_10_14_19$total_prelim_votes_2018, na.rm = T)),
  pct_natl_vr_18 = vr_total_2018 / (sum(partial_turnout_reports_10_14_19$vr_total_2018, na.rm = T)),
  pct_natl_vote_2014 = total_prelim_round_one_votes_2014 / (sum(partial_turnout_reports_10_14_19$total_prelim_round_one_votes_2014, na.rm = T))
)
...
#  geom_abline(slope = 1, intercept = 0, size = 1, color="gray80") +
  geom_point() +
#  geom_smooth(method = "lm") +
  scale_y_continuous(limits = c(0, .6), labels = scales::percent_format(accuracy = 1), breaks=seq(0, .6, by=0.05)) +
  scale_x_continuous(limits = c(-.8, .6), labels = scales::percent_format(accuracy = 1), breaks=seq(-.8, .6, by=0.05)) +
  geom_text_repel(data = partial_turnout_reports_10_14_19, 
                  mapping = aes(label = province_name_eng), size = 3, box.padding = unit(0.55, "lines")) +
...
ggsave("./graphics/bvv_provisional_comparison_10_14.png", plot = bvv_vs_provisional, dpi = 300, height = 215.9, width = 279.4, units = "mm")
...
natl_med_turnout_19 <- median(partial_turnout_reports_10_14_19$bvv_proj_turnout_10_14_19)

prov_bvv_turnout <- ggplot(data = partial_turnout_reports_10_14_19, aes(x = turnout_2018, y = bvv_proj_turnout_10_14_19, color = region_name_eng)) +
  coord_fixed(ratio = 1) +
  geom_hline(yintercept = natl_med_turnout_19, size = 1, color = "gray80") +
  geom_vline(xintercept = natl_med_turnout_18, size = 1, color = "gray80") +
  geom_abline(slope = 1, intercept = 0, size = 1, color="gray80") +
...
#  geom_smooth(method = "lm") +
  ...
  geom_text_repel(data = partial_turnout_reports_10_14_19, 
                  mapping = aes(label = province_name_eng), size = 3, box.padding = unit(0.55, "lines")) +
  labs(y = "2019 Projected BVV Votes Against Voter Registration (As of 10-14-19)", 
       x = "2018 Votes Against Voter Registration (Preliminary Results)",
       title = "Provincial-Level Turnout Comparisons in Afghanistan Elections (Projected BVV Votes)",
       subtitle = "Diagonal line represents hypothetical perfect correlation, x- and y-intercept lines are national median.",
       caption = "Author: Colin Cookman (Twitter: @colincookman / Email: ccookman@gmail.com or ccookman@usip.org)\nData Sources:\n2018 parliamentary data: https://github.com/colincookman/afghanistan_election_results_2018\n2019 provisional data: https://github.com/colincookman/afghanistan_presidential_election_2019/",
       color = "UNAMA Region Code"
  ) +
...
ggsave("./graphics/provisional_bvv_turnout_10_14.png", plot = prov_bvv_turnout, dpi = 300, height = 215.9, width = 279.4, units = "mm")



prov_bvv_turnout <- ggplot(data = partial_turnout_reports_10_14_19, aes(x = turnout_10_03_19, y = bvv_proj_turnout_10_14_19, color = region_name_eng)) +
  coord_fixed(ratio = 1) +
  geom_hline(yintercept = natl_med_bvv_turnout_19, size = 1, color = "gray80") +
  geom_vline(xintercept = natl_med_turnout_19, size = 1, color = "gray80") +
  geom_abline(slope = 1, intercept = 0, size = 1, color="gray80") +
  geom_point() +
#  geom_smooth(method = "lm") +
  ...
  geom_text_repel(data = partial_turnout_reports_10_14_19, 
                  mapping = aes(label = province_name_eng), size = 3, box.padding = unit(0.55, "lines")) +
  labs(y = "2019 Projected BVV Votes Against Voter Registration (as of 10-14-19)", 
       x = "2019 Provisional Vote Turnout Against Voter Registration (as of 10-03-19)",
       title = "Provincial-Level Turnout Comparisons in Afghanistan Elections",
       subtitle = "Diagonal line represents hypothetical perfect correlation, x- and y-intercept lines are national median.",
       caption = "Author: Colin Cookman (Twitter: @colincookman / Email: ccookman@gmail.com or ccookman@usip.org)\nData Sources:\n2018 parliamentary data: https://github.com/colincookman/afghanistan_election_results_2018\n2019 provisional data: https://github.com/colincookman/afghanistan_presidential_election_2019/",
       color = "UNAMA Region Code"
